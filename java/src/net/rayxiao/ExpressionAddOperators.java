...
public class ExpressionAddOperators {
    ...
    public static void main(String[] args) {
        String num1 = "123";
        int target1 = 6;
        System.out.println(Arrays.toString(addOperators(num1, target1).toArray()));
    }
    ...
    static private void  dfs(List<String> ret, char[] path, int len, long left, long cur, char[] digits, int pos, int target) {
